...
fprintf(DTG, 'PGENA1:CH2:PRATe SIXTeenth');                                 % configure the input to the pulse shaper (X CLK, AC1)
...
fprintf(DTG, 'PGENA1:CH1:PRATe SIXTeenth');                                 % configure the input to the pulse shaper (Y CLK, AC1!)
...
fprintf(DTG, 'PGENC1:CH1:PRATe OFF');
fprintf(DTG, 'PGENC1:CH2:PRATe OFF');
...
% NOTE: AC2, AC2!, XSG2, and YSG2 must be grounded.
