...
% pulse shaper config
pshaper_config.constructor = @serial;                                       % The DC box is really an arduino that we talk to over USB
...
watd_config.constructor_args = {'Type', 'tcpip', ...
                                ...
                                'Tag', ''};
watd_config.InputBufferSize = 8192;                                         % Input buffer size on the computer end
